...
class EmployeeAdapter(val activity: Activity, val data: MutableList<EmployeePojo>) :
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(employeePojo : EmployeePojo ) {
            ...
            itemView.btn_adapter.setOnClickListener {
                Log.e("data name", "${employeePojo.employeeName}")
                Log.e("data salary", "${employeePojo.employeeSalary}")
                Log.e("data Age", "${employeePojo.employeeAge}")
            }
        }
